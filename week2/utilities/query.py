...
def create_query(user_query, click_prior_query, filters, sort="_score", sortDir="desc", size=10, source=None, use_synonyms=False):
    if use_synonyms:
        field = "name.synonyms"
        print("Test - search with synonyms")
    else:
        field = "name"
        print("Test - search without synonyms")
                        ...
                        "should": [  #
                            ...
                            },
                            {
                                "multi_match": {
                                    ...
                                    "fields": [f"{field}^10", "name.hyphens^10", "shortDescription^5",
...
if __name__ == "__main__":
    ...
    general.add_argument('--synonyms', action="store_false", help='Search with synonyms')
